...
GLfloat cloudSpeed = 1.006f;
void cloudMove(int value) {

    if(cloudPosition < -850.0)
    cloudPosition = 640.02f;
    cloudPosition -= cloudSpeed;
    glutPostRedisplay();
    glutTimerFunc(100, cloudMove, 0);
}

GLfloat waterPosition = 0.0f;
GLfloat waterSpeed = 1.08f;
void waterMove(int value) {

    if(waterPosition < -40.0)
    waterPosition = 0.0;
...
////////////////////////////////
    ...
    glEnd();
//////////////////////
    glBegin(GL_TRIANGLES); // build 10 curved
    glColor3ub(80, 170, 164);
    glVertex2f(-21.9f,237.134f);
    glVertex2f(-21.9f,204.58f);
    glVertex2f(27.22f,204.58f);
    glEnd();
    glBegin(GL_QUADS);
    glColor3ub(80, 170, 164);
    glVertex2f(-21.9f,204.58f);
    glVertex2f(27.22f,204.58f);
    glVertex2f(49.45f,185.17f);
    glVertex2f(-21.9f,185.17f);
    glEnd();
    glBegin(GL_QUADS);
    glColor3ub(80, 170, 164);
    glVertex2f(49.45f,185.17f);
    glVertex2f(-21.9f,185.17f);
    glVertex2f(-21.9f,157.37f);
    glVertex2f(68.72f,157.37f);
    glEnd();
    glBegin(GL_QUADS);
    glColor3ub(80, 170, 164);
    glVertex2f(-21.9f,157.37f);
    glVertex2f(68.72f,157.37f);
    glVertex2f(83.25f,127.67f);
    glVertex2f(-21.9f,127.67f);
    glEnd();
    glBegin(GL_QUADS);
    glColor3ub(80, 170, 164);
    glVertex2f(83.25f,127.67f);
    glVertex2f(-21.9f,127.67f);
    glVertex2f(-21.9f,98.29f);
    glVertex2f(89.89f,98.29f);
    glEnd();
    glBegin(GL_QUADS);
    glColor3ub(80, 170, 164);
    glVertex2f(-21.9f,98.29f);
    glVertex2f(89.89f,98.29f);
    glVertex2f(91.91f,64.78f);
    glVertex2f(-21.9f,64.78f);
    glEnd();
    glBegin(GL_QUADS);
    glColor3ub(80, 170, 164);
    glVertex2f(91.91f,64.78f);
    glVertex2f(-21.9f,64.78f);
    glVertex2f(-21.9f,18.10f);
    glVertex2f(91.91f,18.10f);
    glEnd();
    glBegin(GL_LINES);
    glColor3ub(234, 241, 240);
    glVertex2f(-6.14f,190.6f);
    glVertex2f(-6.14f,43.97f);
    glVertex2f(9.58f,190.6f);
    glVertex2f(9.58f,43.97f);
    glVertex2f(29.93f,190.6f);
    glVertex2f(29.93f,43.97f);
    glEnd();
...
////////////////////////
    ...
    glEnd();
    glBegin(GL_QUADS); //window
    glColor3ub(119, 138, 134);
    glVertex2f(132.17f,201.39f);
    glVertex2f(116.17f,201.39f);
    glVertex2f(116.17f,183.64f);
    glVertex2f(132.17f,183.64f);
    glEnd();
    glBegin(GL_QUADS);
    glColor3ub(119, 138, 134);
    glVertex2f(132.17f,164.36f);
    glVertex2f(117.67f,164.36f);
    glVertex2f(117.67f,112.93f);
    glVertex2f(132.17f,112.93f);
    glEnd();
    glBegin(GL_QUADS);
    glColor3ub(119, 138, 134);
    glVertex2f(132.17f,101.09f);
    glVertex2f(116.17f,101.09f);
    glVertex2f(116.17f,83.75f);
    glVertex2f(132.17f,83.75f);
    glEnd();
/////////////////////////////////
    glBegin(GL_QUADS); // build 12
    glColor3ub(17, 122, 101);
    glVertex2f(249.94f,199.25f);
    glVertex2f(184.02f,199.25f);
    glVertex2f(184.02f,18.10f);
    glVertex2f(249.94f,18.10f);
    glEnd();
    glBegin(GL_QUADS); //window
    glColor3ub(119, 138, 134);
    glVertex2f(238.021f,184.37f);
    glVertex2f(194.38f,184.37f);
    glVertex2f(194.38f,165.57f);
    glVertex2f(238.021f,165.57f);
    glEnd();
    glBegin(GL_QUADS); //window
    glColor3ub(119, 138, 134);
    glVertex2f(238.021f,149.29f);
    glVertex2f(194.38f,149.29f);
    glVertex2f(194.38f,129.72f);
    glVertex2f(238.021f,129.72f);
    glEnd();
    glBegin(GL_QUADS); //window
    glColor3ub(119, 138, 134);
    glVertex2f(238.021f,110.52f);
    glVertex2f(194.38f,110.52f);
    glVertex2f(194.38f,92.06f);
    glVertex2f(238.021f,92.06f);
    glEnd();
    glBegin(GL_QUADS); //window
    glColor3ub(119, 138, 134);
    glVertex2f(238.021f,72.86f);
    glVertex2f(194.38f,72.86f);
    glVertex2f(194.38f,53.66f);
    glVertex2f(238.021f,53.66f);
    glEnd();
    //////////////////////
    glBegin(GL_QUADS); //build 14
    glColor3ub(52, 114, 142);
    glVertex2f(362.71f,179.6f);
    glVertex2f(300.71f,179.6f);
    glVertex2f(300.71f,18.10f);
    glVertex2f(362.71f,18.10f);
    glEnd();
///////////////////////////////////
    glBegin(GL_QUADS); // build 13
    glColor3ub(117, 132, 167);
    glVertex2f(335.82f,220.9f);
    glVertex2f(255.3f,220.9f);
    glVertex2f(255.3f,18.10f);
    glVertex2f(335.82f,18.10f);
    glEnd();
    glBegin(GL_QUADS); // window
    glColor3ub(97, 99, 105);
    glVertex2f(322.87f,210.86f);
    glVertex2f(302.6f,210.86f);
    glVertex2f(302.6f,183.07f);
    glVertex2f(322.87f,183.07f);
    glEnd();
    glBegin(GL_QUADS);
    glColor3ub(97, 99, 105);
    glVertex2f(322.87f,119.97f);
    glVertex2f(302.6f,119.97f);
    glVertex2f(302.6f,93.4f);
    glVertex2f(322.87f,93.4f);
    glEnd();
    glBegin(GL_QUADS);
    glColor3ub(97, 99, 105);
    glVertex2f(289.31f,162.6f);
    glVertex2f(269.202f,162.6f);
    glVertex2f(269.202f,135.4f);
    glVertex2f(289.31f,135.4f);
    glEnd();

    //////////////////////
    glBegin(GL_QUADS); //build 15
    glColor3ub(34, 183, 108);
    glVertex2f(402.348f,162.88f);
    glVertex2f(352.63f,162.88f);
    glVertex2f(352.63f,18.10f);
    glVertex2f(402.348f,18.10f);
    glEnd();
    glBegin(GL_LINES); // window design
    glColor3ub(245, 254, 249);
    glVertex2f(360.50f,156.44f);
    glVertex2f(360.50f,90.12f);
    glVertex2f(370.39f,156.44f);
    glVertex2f(370.39f,90.12f);
    glVertex2f(381.86f,156.44f);
    glVertex2f(381.86f,90.12f);
    glVertex2f(391.75f,156.44f);
    glVertex2f(391.75f,90.12f);
    glVertex2f(365.44f,102.49f);
    glVertex2f(365.44f,35.94f);
    glVertex2f(375.79f,102.49f);
    glVertex2f(375.79f,35.94f);
    glVertex2f(386.13f,102.49f);
    glVertex2f(386.13f,35.94f);
    glEnd();
////////////////////////
    glBegin(GL_QUADS); //build 16
    glColor3ub(34, 183, 108);
    glVertex2f(496.633f,213.98f);
    glVertex2f(416.47f,213.98f);
    glVertex2f(416.47f,18.10f);
    glVertex2f(496.633f,18.10f);
    glEnd();
    glBegin(GL_LINES);
    glColor3ub(245, 254, 249);
    glVertex2f(422.87f,199.4f);
    glVertex2f(491.65f,199.4f);
    glVertex2f(422.87f,176.2f);
    glVertex2f(491.65f,176.2f);
    glVertex2f(422.87f,149.32f);
    glVertex2f(491.65f,149.32f);
    glVertex2f(422.87f,130.19f);
    glVertex2f(491.65f,130.19f);
    glVertex2f(422.87f,105.60f);
    glVertex2f(491.65f,105.60f);
    glEnd();
////////////////////////
    glBegin(GL_QUADS); //build geometric
    glColor3ub(188, 131, 169);
    glVertex2f(573.36f,265.88f);
    glVertex2f(529.47f,190.004f);
    glVertex2f(529.47f,18.10f);
    glVertex2f(573.36f,18.10f);
    glEnd();
    glBegin(GL_QUADS); //build geometric
    glColor3ub(188, 131, 169);
    glVertex2f(573.36f,265.88f);
    glVertex2f(613.58f,240.74f);
    glVertex2f(613.58f,18.10f);
    glVertex2f(573.36f,18.10f);
    glEnd();
    glBegin(GL_LINES);
    glColor3ub(93, 116, 106);
    glVertex2f(573.36f,265.88f);
    glVertex2f(573.36f,18.10f);
    glVertex2f(529.47f,168.97f);
    glVertex2f(573.36f,210.88f);
    glVertex2f(573.36f,210.88f);
    glVertex2f(614.95f,183.14f);
    glVertex2f(529.47f,136.064f);
    glVertex2f(573.36f,160.74f);
    glVertex2f(573.36f,160.74f);
    glVertex2f(614.95f,148.4f);
    glVertex2f(529.47f,108.63f);
    glVertex2f(573.36f,125.09f);
    glVertex2f(573.36f,125.09f);
    glVertex2f(614.95f,113.2f);
    glEnd();
...
void cloud(double orx, double ory, double radius)
{
    glBegin(GL_POLYGON);
...
void sun(double orx, double ory, double radius)
{
    glBegin(GL_POLYGON);
...
void skyBox()
{
    ...
    glVertex2f(-640.0f,360.0f);
    glEnd();
    sun(410.95,231.38, 48);
    glLoadIdentity();
    glPushMatrix();
    glTranslatef(-cloudPosition,0.0f, 0.0f);
    cloud(-583.43,305.13, 20.0);
    cloud(-570.30,295.13, 20.0);
    cloud(-555.0f,295.13, 15.0);

    cloud(-293.38f,279.53, 15.0);
    cloud(-280.38f,279.53, 20.0);
    cloud(-272.38f,289.53, 15.0);
    cloud(-265.38f,289.53, 15.0);
    cloud(-255.38f,284.53, 15.0);

    cloud(-318.291,345.8, 10.0);
    cloud(-326.291,345.8, 10.0);
    cloud(-334.291,345.8, 10.0);

    cloud(-37.72f,327.66f, 10.0);
    cloud(-30.72f,327.66f, 10.0);
    cloud(-30.72f,320.66f, 10.0);
    cloud(-22.72f,327.66f, 13.0);
    ...
    cloud(467.43,305.13, 20.0);
    cloud(454.30,295.13, 20.0);
    cloud(439.0f,295.13, 15.0);
